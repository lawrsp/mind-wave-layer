...
(defun spacemacs//mind-wave-setup-global-bindings ()
  ...
  (spacemacs/declare-prefix "mw"  "mind-wave")
  (spacemacs/set-leader-keys
    ...
    "mwt" 'mind-wave-translate-to-english
    ...
    "mwp" 'mind-wave-proofreading-doc
...
(defun spacemacs//mind-wave-setup-prog-bindings ()
  ...
  (let ((mode major-mode))
    ...
    (spacemacs/set-leader-keys-for-major-mode mode
      ...
      "wg" 'mind-wave-generate-commit-name)))
